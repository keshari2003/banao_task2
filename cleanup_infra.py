...
# # Find resources by name/tag to avoid hardcoding IDs
# try:
#     # --- Clean up ELB resources ---
#     print("Finding Load Balancer...")
#     lb = elbv2_client.describe_load_balancers(Names=['my-app-lb'])['LoadBalancers'][0]
...
#     # Waiter for LB deletion is a bit tricky, a simple sleep is often enough for localstack
    
#     tg = elbv2_client.describe_target_groups(Names=['my-app-targets'])['TargetGroups'][0]
